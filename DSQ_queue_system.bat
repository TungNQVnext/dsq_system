...
if %errorlevel% equ 0 (
    echo ✓ Frontend is responding (http://localhost:5173)
) else (
...
echo.
echo ✅ This setup runs 24/7 without Windows Services
echo    Both processes will restart if windows are accidentally closed
echo.
echo 🌍 Muốn chạy system thì truy cập vào link: http://%MACHINE_IP%:5173/
echo.
